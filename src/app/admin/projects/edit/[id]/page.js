...
import {
    MdSave, MdArrowBack,
    MdDesktopWindows, MdPhoneAndroid, MdVisibility, MdImage,
} from 'react-icons/md';
    ...
    const applyJson = (raw) => {
        try {
            ...
            setFormData(prev => ({
                ...
                // Complex nested objects — used as-is if present
    ...
    const fetchProject = async () => {
        try {
            ...
            const loaded = {
                ...
                carpetAreaLabel: p.carpetAreaLabel || '',
                ...
                schemaPrice: p.schemaPrice || p.price || '',
                schemaPriceCurrency: p.schemaPriceCurrency || 'INR',
                schemaAvailability: p.schemaAvailability || 'InStock',
                schemaLocation: p.schemaLocation || p.projectAddress || '',
                ...
                amenitiesTitle: p.amenitiesTitle || '',
                amenitiesContent: p.amenitiesContent || '',
                keyHighlightsTitle: p.keyHighlightsTitle || '',
                keyHighlights: p.keyHighlights || '',
                highlightItems: Array.isArray(p.highlightItems) ? p.highlightItems : [],
                ctaButtonText: p.ctaButtonText || '',
                configurations: p.configurations || '',
                configurationsTitle: p.configurationsTitle || '',
                configurationsCtaLabel: p.configurationsCtaLabel || '',
                configurationRows: Array.isArray(p.configurationRows) ? p.configurationRows : [],
                ...
                faqs: p.faqs || [],
                hideContent: p.hideContent || false,
                hideEnquireCTA: p.hideEnquireCTA || false,
                hideKeyHighlights: p.hideKeyHighlights || false,
                hideWalkthrough: p.hideWalkthrough || false,
                hideAmenities: p.hideAmenities || false,
                hideConfigurations: p.hideConfigurations || false,
                hideMasterFloorPlan: p.hideMasterFloorPlan || false,
                hideGallery: p.hideGallery || false,
                hideProjectSpecifications: p.hideProjectSpecifications || false,
                hideLocation: p.hideLocation || false,
    ...
    const handleSubmit = async (e, publishStatus = formData.publishStatus) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                Swal.fire('Error', result.error || 'Failed to update project', 'error');
            }
            ...
            <main className={`flex-1 ${sidebarOpen ? 'ml-64' : 'ml-20'} transition-all duration-300`}>
                <div className="p-8">
                    <div className="mb-6">
                        ...
                        <p className="text-gray-500 text-sm mt-1">Update project details, then Save as Draft or Publish.</p>
                    </div>
                        ...
                        <div className="flex gap-6 items-start">
                            ...
                            <div className="flex-1 space-y-6 min-w-0">
                                ...
                                <div className="bg-white rounded-xl shadow-lg p-6">
                                    ...
                                    <p className="text-xs text-gray-400 mb-4">Used by search engines for rich results. Auto-filled from project fields — edit to override.</p>
                                    <div className="space-y-4">
                                        <div>
